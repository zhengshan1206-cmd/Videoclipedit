...
class AiClipMaterialSelectView extends StatelessWidget {
  const AiClipMaterialSelectView({
    super.key,
  });
  @override
            ...
            Row(
              children: [
                ByWidgetsUtil.svgAsset(
                  filePath: "assets/ai/clip/ai_clip_material_add.svg",
                  width: 16,
                  height: 16,
                ),
                SizedBox(width: 5.w),
        ...
        ByNavigatorUtil.checkLogin(
            ...
            nextStepEvent: () {
              ByNavRouterUtils.push(
                ...
                ], child: const AiMaterialSelectPage()),
              );
            });
