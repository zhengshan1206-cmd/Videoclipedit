...
class AiCartoonCopyTextDialog extends StatelessWidget {
  const AiCartoonCopyTextDialog({
    super.key,
  ...
  Widget build(BuildContext context) {
    byDebugPrint("AiCartoonCopyTextDialog_build");
    return Scaffold(
        ...
        children: [
          Expanded(
            child: ByWidgetsUtil.commonBtn(
              ...
              onClick: () {
                Clipboard.setData(ClipboardData(text: videoBean.text));
