...
import '../providers/ai_oral_dubbing_provider.dart';
import 'ai_create_text_dialog.dart';

class AiCommonInputView<T extends AiInputMixin> extends StatelessWidget {
  final EdgeInsetsGeometry? padding;

  const AiCommonInputView({
    super.key,
    this.padding,
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          AiWriteTextView(textEditingController: controller,),
        ],
      ),
    );
  }
  ...
  Widget _pasteBtnView() {
    return GestureDetector(
      ...
      child: Container(
        ...
        padding: EdgeInsets.only(left: 8.w, right: 8.w, top: 6.w, bottom: 6.w),
        child: Text(
          "粘贴",
          style: TextStyle(
