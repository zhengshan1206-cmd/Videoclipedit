import 'before_after_theme.dart';
...
///
/// The [BeforeAfter] widget displays two images, [after] and [before], with a draggable slider in between.
...
///
/// Note: The [after] and [before] widgets should have the same size.
class BeforeAfter extends StatefulWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<Widget>('before', after));
    properties.add(DiagnosticsProperty<Widget>('after', before));
...
class _BeforeAfterDefaultsM3 extends BeforeAfterTheme {
  _BeforeAfterDefaultsM3(BuildContext context)
      : _colors = Theme.of(context).colorScheme,
        super(trackWidth: 2.0, thumbWidth: 24.0, thumbHeight: 24.0);

  final ColorScheme _colors;

  @override
  Color get trackColor => Colors.white;
