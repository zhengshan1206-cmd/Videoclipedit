...
class NewOldPhotoFixPage extends StatefulWidget {
  const NewOldPhotoFixPage({super.key});

  @override
  State<NewOldPhotoFixPage> createState() => _NewOldPhotoFixPageState();
}

class _NewOldPhotoFixPageState extends State<NewOldPhotoFixPage>
  ...
  void showRecords() {
    ByNavRouterUtils.push(
        ...
        MultiProvider(
          ...
          child: AiPhotoFixManagementPage(type: kAiOldPhotoFixTaskType),
        ));
  }
      ...
      body: Stack(
        children: [
          Positioned(
            ...
            right: 0,
            child: Image.asset(
              "assets/ai/aiPhotoFix/bg@2x.png",
              fit: BoxFit.fitWidth,
            ),
          ),
          _buildBody(context),
  ...
  // 积分-vip-次数-消耗模块-老照片修复
  Widget _buildIntegralVipView() {
    return const IntegralVipView(
      requiredPoints: 0,
      type: "refix_image_old", // 通过这个type请求权益接口获取实际积分
    );
  }
