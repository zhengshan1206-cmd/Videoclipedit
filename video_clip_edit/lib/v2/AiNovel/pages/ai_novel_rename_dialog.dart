...
class AiNovelRenameDialog extends StatefulWidget {
  const AiNovelRenameDialog({
    super.key,
    this.onFinish,
  });
  ...
  @override
  State<AiNovelRenameDialog> createState() =>
      _AiNovelRenameDialogState();
}

class _AiNovelRenameDialogState
    extends State<AiNovelRenameDialog> {
