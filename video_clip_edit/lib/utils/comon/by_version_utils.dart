...
class ByVersionUtils {
  ...
  static Future androidCheckUpdate() async {
    ...
    if (data.isNotEmpty) {
      ...
      String appVersion = await ByPackageUtils.version();
      bool hasNewVersion = ByVersionUtils.hasNewVersion(appVersion, version);
  ...
  static int compareVersions(String version1, String version2) {
    ...
    final minLength = v1Segments.length < v2Segments.length
        ? v1Segments.length
        : v2Segments.length;
