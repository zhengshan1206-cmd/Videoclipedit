...
class ShortShowRecreatePage<T extends MaterialBaseProvider>
    extends StatelessWidget {
  const ShortShowRecreatePage({super.key});
  ...
  _buildBanner(BuildContext context) {
    final bannerBeans = context.select<ShowRecreateProvider, List<SubFunction>>(
    ...
    return Positioned(
      ...
      child: BannerView(
        urls: bannerBeans.isEmpty
            ? const ["assets/home/banner_create.png"]
