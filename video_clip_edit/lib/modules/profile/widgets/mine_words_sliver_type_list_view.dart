...
class MineWordsSliverTypeListView extends StatelessWidget {
  const MineWordsSliverTypeListView({
    super.key,
  ...
  Widget build(BuildContext context) {
    final selectedIndex = context.select<MineWordsManagementProvider, int>(
