...
class MineVideosSliverTypeListView extends StatelessWidget {
  const MineVideosSliverTypeListView({
    super.key,
  ...
  Widget build(BuildContext context) {
    final selectedIndex = context.select<MineVideosManagementProvider, int>(
      ...
      delegate: StickyHeaderDelegate(
        ...
        child: Stack(
          children: [
            ...
            Positioned.fill(
              child: Offstage(
                offstage: context.select<MineVideosManagementProvider, bool>(
