...
import 'package:video_clip_edit/modules/guid/clip/content_guid_page.dart';
...
class ClipVoiceoverSubtitleGuidPage extends StatefulWidget {
  const ClipVoiceoverSubtitleGuidPage({super.key});

  @override
  State<ClipVoiceoverSubtitleGuidPage> createState() =>
      _ClipVoiceoverSubtitleGuidPageState();
}

class _ClipVoiceoverSubtitleGuidPageState
    extends State<ClipVoiceoverSubtitleGuidPage> {
    ...
    return GestureDetector(
      ...
      onTap: () {
        ByNavRouterUtils.pushReplacement(
          ...
          ChangeNotifierProvider(
            create: (context) => ClippedProvider(),
            child: ContentGuidPage(
              index: index,
            ),
          ),
        );
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            top: ByScreenUtils.topSafeHeight + (56.h - 32.h) * 0.5,
            left: 153.w,
            right: 10.w,
            child: Image.asset(
              "assets/guid/guid_clip_voice_subtitle_tips_top.png",
              fit: BoxFit.fitWidth,
            ),
          ),
          Positioned(
            // bottom: 32.h,
            top: 140.h + 30.h + 56.h + ByScreenUtils.topSafeHeight,
            left: 12.w,
            right: 10.w,
            child: Image.asset(
              "assets/guid/guid_clip_voice_subtitle_tips_middle_$index.png",
              fit: BoxFit.fitWidth,
            ),
          ),
  ...
  ClipRRect _buildVideoPreview() {
    return ClipRRect(
      ...
      child: SizedBox(
        height: 100.h,
        child: Image.asset("assets/guid/${Random().nextInt(10) + 1}.jpg"),
      ),
    );
  }
