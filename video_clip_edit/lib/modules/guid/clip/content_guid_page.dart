...
import 'package:video_clip_edit/modules/guid/clip/clip_guid_content_view.dart';
...
class ContentGuidPage extends StatefulWidget {
  final int index;
  const ContentGuidPage({
    super.key,
    required this.index,
  });

  @override
  State<ContentGuidPage> createState() => _ContentGuidPageState();
}

class _ContentGuidPageState extends State<ContentGuidPage> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      onTap: () {
        ByNavRouterUtils.pushReplacement(context, const VideoLoadingGuidPage());
      },
      child: Stack(
        children: [
          Scaffold(
          ...
          Positioned(
            ...
            bottom: 8.w,
            child: Image.asset(
              "assets/guid/guid_clip_hyber_content_tips_bottom.png",
              fit: BoxFit.fitWidth,
            ),
          ),
