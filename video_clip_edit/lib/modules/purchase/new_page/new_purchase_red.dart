...
import '../../../v2/folkStory/widget/folk_story_success_create.dart';
import '../../../widgets/toast_util.dart';
import '../../home/widgets/sub_funcs_view.dart';
import '../ios_purchase_page.dart';
...
class NewPurchasePageRed extends StatefulWidget {
  final bool? closePay;

  const NewPurchasePageRed({super.key, this.closePay});

  @override
  State<NewPurchasePageRed> createState() => _NewPurchasePageRedState();
}

class _NewPurchasePageRedState extends State<NewPurchasePageRed>
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              mainAxisSize: MainAxisSize.min,
                              children: [
                                const NewVIPCountDownWidget(isBlue: false),
  ...
  Widget _buildTitle() {
    return Padding(
      ...
      child: Image.asset(Assets.purchaseOpenVipRed, height: 62.h),
    );
  }
          ...
          provider?.vipRightsBeans.map((e) {
            return Container(
              child: Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Image.asset(e.redIcon, width: 32, height: 32),
                  Text(
                    e.name,
  ...
  Widget _buildVIPTypeListView(BuildContext context) {
    return const Padding(
      ...
      child: NewVipListViewNew(isBlue: false),
    );
  }
      ...
      child: Container(
        ...
        child: ByWidgetsUtil.gradientBtn(
          ...
          gradient: ByColorUtil.lineareGradient(
            ...
            colorEnd: const Color(0xFFFF387A),
